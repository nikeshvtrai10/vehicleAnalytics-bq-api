...
@overview.route('/', methods=['POST'], strict_slashes=False)
def reachSummary():
...
@overview.route('/daily', methods=['POST'])
def dailyReach():
    error, code, msg = verify_headers(request.headers)
    if error:
        message = {
...
@overview.route('/day', methods=['POST'])
def reachByDay():
    error, code, msg = verify_headers(request.headers)
    if error:
        message = {
...
@overview.route('/time', methods=['POST'])
def reachByTime():
    error, code, msg = verify_headers(request.headers)
    if error:
        message = {
...
@overview.route('/vehicletype', methods=['POST'])
...
@overview.route('/dwelltime', methods=['POST'])
